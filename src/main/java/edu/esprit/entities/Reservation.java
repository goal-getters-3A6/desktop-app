...
//private ServiceSeance seanceService;
    ...
    public Reservation(int idReservation, Seance seance, String nom, String prenom, int age, float poids, float taille, String sexe) {
    ...
    public Reservation(Seance seance, String nom, String prenom, int age, float poids, float taille, String sexe) {
        this.seance = seance;
        this.nom = nom;
        this.prenom = prenom;
        this.age = age;
